        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(103 * fem, 11 * fem, 10 * fem, 12 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(6 * fem, 16 * fem, 6 * fem, 25 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(5 * fem, 16 * fem, 5 * fem, 18 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
                color: Color(0xffafdae3),
              ),
